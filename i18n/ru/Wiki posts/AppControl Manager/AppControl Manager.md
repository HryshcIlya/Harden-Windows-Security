...
Here is the complete list of all of the URLs the AppControl Manager application connects to _**(or is mentioned in the User Interface)**_ with proper justification for each of them.
